...
public:
	...
	bool Endgame_K(COLOR side) const { return m_matIndex[side] == 0 && m_count[PAWN | side] == 0; }
	bool Endgame_KP(COLOR side) const { return m_matIndex[side] == 0 && m_count[PAWN | side] == 1; }
	bool Endgame_KBP(COLOR side) const { return m_matIndex[side] == 3 && m_count[BISHOP | side] == 1 && m_count[PAWN | side] == 1; }
	bool Endgame_KBPX(COLOR side) const { return m_matIndex[side] == 3 && m_count[BISHOP | side] == 1; }
...
inline FLD StepForward(FLD f, COLOR side) { return f - 8 + 16 * side; }

                    ...
                    if (castle & KC)
                    {
                        ...
                        if (!board[f1] && !board[g1])
                        {
                            ...
                            if (!is_square_attacked(e1, black) && !is_square_attacked(f1, black))
                                printf("%s%s\n", square_to_coords[e1], square_to_coords[g1]);
                        }
                    }
                    ...
                    if (castle & QC)
                    {
                        ...
                        if (!board[d1] && !board[b1] && !board[c1])
                        {
                            ...
                            if (!is_square_attacked(e1, black) && !is_square_attacked(d1, black))
                                printf("%s%s\n", square_to_coords[e1], square_to_coords[c1]);
                        }
                    }
                }
            }
                    ...
                    if (castle & kc)
                    {
                        ...
                        if (!board[f8] && !board[g8])
                        {
                            ...
                            if (!is_square_attacked(e8, white) && !is_square_attacked(f8, white))
                                printf("%s%s\n", square_to_coords[e8], square_to_coords[g8]);
                        }
                    }
                    ...
                    if (castle & qc)
                    {
                        ...
                        if (!board[d8] && !board[b8] && !board[c8])
                        {
                            ...
                            if (!is_square_attacked(e8, white) && !is_square_attacked(d8, white))
                                printf("%s%s\n", square_to_coords[e8], square_to_coords[c8]);
                        }
                    }
                }
            }
